...
class Server:
    def __init__(self):
        ...
        self.uav3 = UAV(0.0, -2.0, 1.0, 3)
        self.uav4 = UAV(0.0, 2.0, 1.0, 4)

        self.num_of_robots = 5
    ...
    def command_formation(self):
        ...
        self.uav3.x = -2.0 * self.d
        self.uav3.y = -2.0 * self.d
        self.uav3.z = 1.0
        msg3 = make_pose_stamped([0.0, 0.0, 0.0, 1.0], [self.uav3.x, self.uav3.y, self.uav3.z])
        self.uav3.pose_publisher.publish(msg3)

        self.uav4.x = -2.0 * self.d
        self.uav4.y = 2.0 * self.d
        self.uav4.z = 1.0
        msg4 = make_pose_stamped([0.0, 0.0, 0.0, 1.0], [self.uav4.x, self.uav4.y, self.uav4.z])
        self.uav4.pose_publisher.publish(msg4)
    ...
    def command_horizontal(self):
        ...
        self.uav3.x = 0.0
        self.uav3.y = -2.0 * self.h
        self.uav3.z = 1.0
        msg3 = make_pose_stamped([0.0, 0.0, 0.0, 1.0], [self.uav3.x, self.uav3.y, self.uav3.z])
        self.uav3.pose_publisher.publish(msg3)

        self.uav4.x = 0.0
        self.uav4.y = 2.0 * self.h
        self.uav4.z = 1.0
        msg4 = make_pose_stamped([0.0, 0.0, 0.0, 1.0], [self.uav4.x, self.uav4.y, self.uav4.z])
        self.uav4.pose_publisher.publish(msg4)
    ...
    def command_vertical(self):
        ...
        self.uav3.x = -2.0 * self.v
        self.uav3.y = 0.0
        self.uav3.z = 1.0
        msg3 = make_pose_stamped([0.0, 0.0, 0.0, 1.0], [self.uav3.x, self.uav3.y, self.uav3.z])
        self.uav3.pose_publisher.publish(msg3)

        self.uav4.x = 2.0 * self.v
        self.uav4.y = 0.0
        self.uav4.z = 1.0
        msg4 = make_pose_stamped([0.0, 0.0, 0.0, 1.0], [self.uav4.x, self.uav4.y, self.uav4.z])
        self.uav4.pose_publisher.publish(msg4)
    ...
    def process_data(self, data, address):
        ...
        if data == "c":
            ...
            self.s.sendto((str(0) + ',' + str(0) + ',' + str(1)).encode('utf-8'), address)
            ...
            self.uav3.land_on = True
            self.uav4.land_on = True
            ...
            self.uav3.land_on = False
            self.uav4.land_on = False
